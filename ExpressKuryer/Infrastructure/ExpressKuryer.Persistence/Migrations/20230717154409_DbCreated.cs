    ...
    public partial class DbCreated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BeCouirers", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "express_contact",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_express_contact", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_express_pakets", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "express_partners",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_express_partners", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Depozit = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Icon = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    OwnAvragePercent = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    WhoIsModified = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_express_services", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_express_settings", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "express_sliders",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_express_sliders", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "express_Subscribes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_express_Subscribes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Gain = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CourierPersonId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    WhoIsModified = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsInterestFree = table.Column<bool>(type: "bit", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_express_PartnersProducts", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    expressDelivery = table.Column<bool>(type: "bit", nullable: true),
                    suprizDelivery = table.Column<bool>(type: "bit", nullable: true),
                    ...
                    OrderDeliveryStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MemberUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CourierId = table.Column<int>(type: "int", nullable: true),
                    CompanyGain = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CourierGain = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    WhoIsModified = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_express_deliveries_express_services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "express_services",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductImages_express_PartnersProducts_PartnerProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_express_deliveries_ServiceId",
                table: "express_deliveries",
                column: "ServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductImages_PartnerProductId",
                table: "ProductImages",
